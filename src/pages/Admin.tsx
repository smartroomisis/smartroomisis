        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <ScrollArea className="w-full whitespace-nowrap pb-2 -mx-4 px-4">
            <TabsList className="inline-flex h-auto p-1 gap-1 bg-muted/50 rounded-lg min-w-max w-max">
              ...
              <TabsTrigger value="financial" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
                <DollarSign className="w-4 h-4" />
                Financeiro
              </TabsTrigger>
              <TabsTrigger value="companies" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
                <Building2 className="w-4 h-4" />
                Empresas
              </TabsTrigger>
              <TabsTrigger value="credits" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
                <Wallet className="w-4 h-4" />
                Créditos
              </TabsTrigger>
              <TabsTrigger value="plans" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
                <CreditCard className="w-4 h-4" />
                Planos
              </TabsTrigger>
              <TabsTrigger value="staff" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
                <Users className="w-4 h-4" />
                Colaboradores
              </TabsTrigger>
              <TabsTrigger value="reports" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
                <FileBarChart className="w-4 h-4" />
                Relatórios
              </TabsTrigger>
              <TabsTrigger value="mei" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
                <Target className="w-4 h-4" />
                MEI
              </TabsTrigger>
              <TabsTrigger value="das" className="flex items-center gap-2 px-3 py-2 text-sm whitespace-nowrap">
